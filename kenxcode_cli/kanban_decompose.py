...
Invoked by ``kenxcode kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the KenXCode Agent board.
...
def _profile_author() -> str:
    """Mirror of ``kenxcode_cli.kanban._profile_author``."""
    return (
