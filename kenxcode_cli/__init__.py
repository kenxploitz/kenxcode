"""
KenXCode CLI - Unified command-line interface for KenXCode Agent.

Provides subcommands for:
- kenxcode chat          - Interactive chat (same as ./kenxcode)
- kenxcode gateway       - Run gateway in foreground
- kenxcode gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `kenxcode setup` on a fresh Pi.
    ...
    kenxcode_cli/stdio.py::configure_windows_stdio() runs later from the entry
