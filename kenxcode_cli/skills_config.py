"""
Skills configuration for KenXCode Agent.
`kenxcode skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.kenxcode/config.yaml under:
...
from kenxcode_cli.config import cfg_get, load_config, save_config
from kenxcode_cli.colors import Colors, color
from kenxcode_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `kenxcode skills`."""
    from kenxcode_cli.curses_ui import curses_checklist
