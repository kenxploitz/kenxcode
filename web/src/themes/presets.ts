 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `kenxcode_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "KenXCode Teal",
  description: "Classic dark teal — the canonical KenXCode look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "KenXCode Teal (Large)",
  description: "KenXCode Teal with bigger fonts and roomier spacing",
