...
const STORAGE_KEY = "kenxcode-dashboard-theme";
...
const FONT_STORAGE_KEY = "kenxcode-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `kenxcode_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "kenxcode-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-kenxcode-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-kenxcode-theme-font", "true");
