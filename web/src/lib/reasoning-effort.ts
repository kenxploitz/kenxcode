 ...
 *
 * Values mirror kenxcode_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the KenXCode default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (KenXCode' default when unset). */
