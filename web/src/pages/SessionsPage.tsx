...
const SOURCE_CONFIG: Record<string, { icon: typeof Terminal; color: string }> =
  {
    ...
    kenxcode_flow: { icon: Play, color: "text-warning" },
...
const NO_MATCHING_SESSION_SOURCE = "__kenxcode_dashboard_no_matching_source__";
    ...
    async (id: string) => {
      try {
        const res = await fetch(api.exportSessionUrl(id), {
          credentials: "include",
          headers: {
            "X-KenXCode-Session-Token":
              (window as unknown as { __KENXCODE_SESSION_TOKEN__?: string })
                .__KENXCODE_SESSION_TOKEN__ ?? "",
          },
        });
