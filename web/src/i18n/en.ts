...
export const en: Translations = {
  ...
  status: {
    ...
    updateKenXCodeConfirmMessage:
      "This runs kenxcode update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateKenXCodeConfirmNow: "Update now",
    updateKenXCodeConfirmTitle: "Update KenXCode?",
    updatingKenXCode: "Updating KenXCode…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update KenXCode plugins (`kenxcode plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.kenxcode/plugins/?",
    removeHint: "Only user-installed plugins under ~/.kenxcode/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.kenxcode/skills/",
  ...
  config: {
    configPath: "~/.kenxcode/config.yaml",
    filters: "Filters",
    sections: "Sections",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that KenXCode doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      title: "KenXCode Achievements",
      subtitle:
        "Collectible KenXCode badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning KenXCode session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run KenXCode more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once KenXCode sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "KenXCode is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in KenXCode Agent ☤",
    },
  },
