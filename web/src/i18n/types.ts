...
export interface Translations {
  ...
  status: {
    ...
    updateKenXCodeConfirmMessage?: string;
    updateKenXCodeConfirmNow?: string;
    updateKenXCodeConfirmTitle?: string;
    updatingKenXCode: string;
  ...
  // ── Achievements plugin (plugins/kenxcode-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;
