 ...
 * `window.__KENXCODE_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the KenXCode brand in the top bar
 ...
 *  `window.__KENXCODE_PLUGINS__.registerSlot(...)`.
 *
