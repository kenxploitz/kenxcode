/**
 * KenXCode Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__KENXCODE_PLUGIN_SDK__`` and
 * ``window.__KENXCODE_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__KENXCODE_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``KenXCodePluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@kenxcode/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__KENXCODE_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__KENXCODE_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__KENXCODE_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface KenXCodePluginSDK {
...
declare global {
  interface Window {
    __KENXCODE_PLUGIN_SDK__?: KenXCodePluginSDK;
    __KENXCODE_PLUGINS__?: PluginRegistry;
  }
}
