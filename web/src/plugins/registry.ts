 ...
 *
 * Plugins call window.__KENXCODE_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__KENXCODE_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__KENXCODE_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__KENXCODE_PLUGIN_SDK__ = {
    ...
    // window.__KENXCODE_SESSION_TOKEN__ directly.
    authedFetch,
