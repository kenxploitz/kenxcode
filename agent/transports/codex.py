...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around KenXCode's web-provider config and
        ...
        # native search engine for xAI sessions instead of KenXCode's
        # configured web provider (Tavily/etc.), and those results bypass
        # KenXCode's tool-trace / citation plumbing (they arrive baked into the
