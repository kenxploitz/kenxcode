...
def build_turn_context(
    ...
    *,
    ...
    # Tag log records on this thread with the session ID for ``kenxcode logs``.
    ...
    if agent.compression_enabled and _should_run_preflight_estimate(
        ...
        # KenXCode only initiates compaction in "kenxcode" mode (#36801).
        _codex_native_auto = (
        ...
        if _preflight_deferred:
            ...
            logger.info(
                "Skipping KenXCode preflight compression for codex app-server "
                "(mode=%s); KenXCode will not start thread compaction here.",
