...
The unit tests in tests/kenxcode_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned kenxcode-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/kenxcode")
from kenxcode_cli.service_manager import S6ServiceManager
