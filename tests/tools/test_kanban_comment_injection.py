...
def worker_home(tmp_path, monkeypatch):
    ...
    for var in ("KENXCODE_KANBAN_DB", "KENXCODE_KANBAN_WORKSPACES_ROOT", "KENXCODE_KANBAN_HOME", "KENXCODE_KANBAN_BOARD"):
...
def test_seed_then_inject_new_comment(worker_home, monkeypatch):
    ...
    monkeypatch.setenv("KENXCODE_PROFILE", "worker-bot")
    agent = FakeAgent()
