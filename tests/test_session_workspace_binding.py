"""Session <-> workspace grouping key (kenxcode_state.workspace_key).

The key is what `kenxcode sessions list --workspace` groups/filters on. It is a
...
from kenxcode_state import workspace_key
