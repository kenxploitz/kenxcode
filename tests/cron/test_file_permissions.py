...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("kenxcode_cli.config.get_config_path", return_value=config_path), \
             patch("kenxcode_cli.config.ensure_kenxcode_home"):
    ...
    def test_ensure_kenxcode_home_sets_0700(self):
        home = Path(self.tmpdir) / ".kenxcode"
