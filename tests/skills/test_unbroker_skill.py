...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and kenxcode-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # kenxcode-agent (tests/skills/)
]
