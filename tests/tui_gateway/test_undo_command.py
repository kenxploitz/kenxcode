...
def server(kenxcode_home):
    ...
    # and re-captures module-level paths like _kenxcode_home against this
...
@pytest.fixture()
def db(kenxcode_home):
    return SessionDB(db_path=kenxcode_home / "state.db")
