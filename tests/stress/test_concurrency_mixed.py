...
def worker_loop(worker_id: int, kenxcode_home: str, result_file: str) -> None:
...
def reclaimer_loop(kenxcode_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="kenxcode_mixed_stress_")
    print(f"KENXCODE_HOME = {home}")
