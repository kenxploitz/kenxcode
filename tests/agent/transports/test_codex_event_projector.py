"""Tests for CodexEventProjector — codex item/* events → KenXCode messages list.
...
class TestRoleAlternationInvariant:
    ...
    one item — that breaks KenXCode' message alternation invariant."""
