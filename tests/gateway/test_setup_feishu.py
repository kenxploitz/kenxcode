"""Tests for _setup_feishu() in kenxcode_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("kenxcode_cli.config.save_env_value", side_effect=mock_save), \
         patch("kenxcode_cli.config.get_env_value", side_effect=mock_get), \
         patch("kenxcode_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("kenxcode_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("kenxcode_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("kenxcode_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("kenxcode_cli.cli_output.print_header"), \
         patch("kenxcode_cli.cli_output.print_info"), \
         patch("kenxcode_cli.cli_output.print_success"), \
         patch("kenxcode_cli.cli_output.print_warning"), \
         patch("kenxcode_cli.cli_output.print_error"), \
