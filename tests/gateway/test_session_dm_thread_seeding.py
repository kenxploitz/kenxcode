...
def store(tmp_path, monkeypatch):
    ...
    ~/.kenxcode/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at kenxcode_state import time, before pytest's KENXCODE_HOME monkeypatch
    fires — the autouse fixture's KENXCODE_HOME override doesn't help here.)
    """
