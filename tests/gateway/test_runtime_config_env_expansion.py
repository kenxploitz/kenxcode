...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("KENXCODE_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("KENXCODE_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("KENXCODE_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
