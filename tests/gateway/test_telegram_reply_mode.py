...
class TestTelegramYamlConfigLoading:
    ...
    def _write_config(self, tmp_path, content: str):
        ...
        kenxcode_home.mkdir()
        (kenxcode_home / "config.yaml").write_text(content, encoding="utf-8")
    ...
    def test_extra_reply_to_mode_off(self, tmp_path, monkeypatch):
        ...
        kenxcode_home = self._write_config(
            tmp_path, "telegram:\n  extra:\n    reply_to_mode: \"off\"\n"
        )
...
class TestDMTopicFallbackReplyToMode:
    ...
    Regression tests for https://github.com/NousResearch/kenxcode-agent/issues/23994:
    reply_to_mode 'off' was ignored when sending via KenXCode-created DM topic
