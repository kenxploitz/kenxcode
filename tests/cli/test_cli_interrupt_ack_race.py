...
Root cause: ``KenXCodeCLI.chat()`` fires ``agent.interrupt(msg)`` from its
...
def _make_cli():
    """Build a KenXCodeCLI with prompt_toolkit stubbed (same pattern as
