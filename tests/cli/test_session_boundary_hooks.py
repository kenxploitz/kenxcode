...
from kenxcode_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/kenxcode_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("kenxcode_cli.lifecycle.invoke_hook")
@patch("kenxcode_cli.lifecycle.finalize_session")
