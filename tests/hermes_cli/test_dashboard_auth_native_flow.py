...
Run: pytest tests/kenxcode_cli/test_dashboard_auth_native_flow.py
"""
...
from kenxcode_cli.dashboard_auth.base import Session
...
def _walk_native_login(client, *, redirect_uri, challenge, state="cli-state"):
    ...
    assert "kenxcode_session_at" not in set_cookie, (
