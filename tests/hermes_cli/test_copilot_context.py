...
def _clear_cache():
    ...
    import kenxcode_cli.models as mod
...
class TestGetCopilotModelContext:
    ...
    @patch("kenxcode_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("kenxcode_cli.models.fetch_github_model_catalog", return_value=[])
