"""Tests for the ``kenxcode prompt-size`` diagnostic (issue #34667)."""
...
from kenxcode_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(kenxcode_home, memory_text="", user_text=""):
    mem_dir = kenxcode_home / "memories"
...
def _seed_skill(kenxcode_home, name, description):
    skill_dir = kenxcode_home / "skills" / "demo" / name
