"""Tests for the specifier module + `kenxcode kanban specify` CLI surface.
...
from kenxcode_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `kenxcode kanban …` argparse surface directly."""
