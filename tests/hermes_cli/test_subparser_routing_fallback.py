...
The main() function in kenxcode_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `kenxcode -c model`
...
def _build_parser():
    """Build a minimal replica of the kenxcode top-level parser."""
