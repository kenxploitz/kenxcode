...
from kenxcode_state import FTS_STORAGE_VERSION, SCHEMA_VERSION, SessionDB
from kenxcode_cli import session_recovery
...
def test_snapshot_blocks_connections_opened_during_the_copy(
    ...
    from kenxcode_cli import session_recovery as recovery_module
...
def test_cli_allow_partial_salvages_rows_across_a_corrupt_leaf(
    ...
    env = os.environ.copy()
    env["KENXCODE_HOME"] = str(tmp_path / "isolated-kenxcode-home")
