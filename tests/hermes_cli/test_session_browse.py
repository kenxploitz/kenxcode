"""Tests for the interactive session browser (`kenxcode sessions browse`).
...
from kenxcode_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """kenxcode sessions browse should be parseable."""
