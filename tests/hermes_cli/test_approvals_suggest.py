"""Tests for ``kenxcode approvals suggest`` (kenxcode_cli/approvals_suggest.py).

Approval history in KenXCode is implied, not ledgered: the session DB
...
from kenxcode_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
