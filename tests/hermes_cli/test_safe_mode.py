"""Tests for `kenxcode chat --safe-mode` isolation."""
...
_VARS = ("KENXCODE_SAFE_MODE", "KENXCODE_IGNORE_USER_CONFIG", "KENXCODE_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["KENXCODE_SAFE_MODE"] == "1"
        assert os.environ["KENXCODE_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["KENXCODE_IGNORE_RULES"] == "1"
        return True
