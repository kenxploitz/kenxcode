"""Tests for `kenxcode secrets bitwarden token` / `kenxcode secrets onepassword token`.
...
from kenxcode_cli import onepassword_secrets_cli as op_cli
from kenxcode_cli import secrets_cli as bw_cli
