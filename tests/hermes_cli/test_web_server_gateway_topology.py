...
class TestStatusEndpointTopology:
    ...
    def _setup_client(self, monkeypatch, _isolate_kenxcode_home):
        try:
    ...
    def test_profile_names_and_mode_public_when_auth_gated(self, monkeypatch):
        ...
        # KenXCode Cloud Portal reads /api/status over the network (a gated bind)
        ...
        try:
            ...
            # alongside kenxcode_home / gateway_pid.
            assert "gateways" not in data
            assert "kenxcode_home" not in data
