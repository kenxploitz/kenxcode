...
2. ``kenxcode_cli.main._refresh_windows_gateway_launchers`` — ``kenxcode
...
def test_restart_spec_normalizes_legacy_pythonw_argv(tmp_path):
    ...
    argv = [str(pythonw), "-m", "kenxcode_cli.main", "gateway", "run"]
    ...
    ), mock.patch("kenxcode_cli.config.get_kenxcode_home", return_value=str(tmp_path)):
...
# ---------------------------------------------------------------------------
# _refresh_windows_gateway_launchers: kenxcode update regenerates launchers
# ---------------------------------------------------------------------------
