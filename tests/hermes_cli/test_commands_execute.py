...
Every ``CommandDef`` with ``execute`` set must:
  * name a key that exists in :data:`kenxcode_cli.slash_exec.EXECUTORS`, and
...
from kenxcode_cli.commands import COMMAND_REGISTRY, resolve_command
from kenxcode_cli.slash_exec import (
    EXECUTORS,
    CommandContext,
    CommandReply,
    execute_command,
