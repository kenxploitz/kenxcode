...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (kenxcode_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_kenxcode_overlays():
    """kenxcode_cli.providers.get_provider("vertex") backs
