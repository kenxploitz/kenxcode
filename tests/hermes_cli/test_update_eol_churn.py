"""Regression: ``kenxcode update`` should take a managed checkout off autocrlf=true.
...
``kenxcode update`` has to repair them.
...
from kenxcode_cli.update_cmd import _normalize_managed_eol
