# Streaming LLM Response Support for KenXCode Agent
...
```
KENXCODE_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("KENXCODE_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `kenxcode_cli/config.py` | 1 | +streaming config defaults |
...
KENXCODE_STREAMING_ENABLED=true
```
