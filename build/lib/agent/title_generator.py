...
def _auto_title_enabled() -> bool:
    ...
    try:
        ...
        # from agent code paths where a module-level kenxcode_cli import risks
...
def auto_title_session(
    ...
    post-``kenxcode update`` stale-module window, where this function's lazy
    ...
    try:
        ...
        logger.warning(
            ...
            "restart the running KenXCode process): %s",
            e,
        )
