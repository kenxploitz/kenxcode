"""Core NeMo Relay adapters for physical KenXCode provider attempts."""
...
def execute_current(
    ...
    *,
    ...
    """Run a provider attempt under the inherited KenXCode turn when present."""
...
def stream_current(
    ...
    *,
    ...
    """Run a provider stream under the inherited KenXCode turn when present.
...
class ManagedLlmStream(Iterator[Any]):
    """Drive Relay's async stream from KenXCode's provider worker thread."""
...
class AnthropicStreamAccumulator:
    ...
    def response(self, base: Any = None) -> Any:
        """Return the attribute-shaped response consumed by KenXCode."""
