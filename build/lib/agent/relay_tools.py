"""Core NeMo Relay adapter for KenXCode tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the KenXCode tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous KenXCode Relay tool execution cannot run on an active event-loop thread"
    )
