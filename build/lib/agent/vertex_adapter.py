"""Vertex AI (Google Cloud) adapter for KenXCode Agent.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows KenXCode to use Gemini models via Google Cloud with
...
# who installed plain `kenxcode-agent` and only later selected a Gemini model.
try:
