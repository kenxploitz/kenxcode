...
the get_anchored_view / get_messages_around primitives in kenxcode_state.
...
# Third-party integrations tag their sessions with KENXCODE_SESSION_SOURCE=tool;
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from kenxcode_state import _default_db_path
...
SESSION_SEARCH_SCHEMA = {
    ...
    "description": (
        ...
        "SOURCE-FIRST LIMIT\n\n"
        "  This tool searches KenXCode conversation history only. It is not evidence "
        ...
        "reformat it as a markdown link or wrap it in backticks. KenXCode renders "
        ...
        "(`deploy*`).\n\n"
        "WHEN TO USE\n\n"
        "  Reach for this on questions about KenXCode conversation history itself, such "
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "profile": {
                "type": "string",
                "description": (
                    "Optional. Read sessions from another KenXCode profile's database "
