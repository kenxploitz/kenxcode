...
Trust levels:
  - builtin:   Ships with KenXCode. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.kenxcode/\.env|\~/\.kenxcode/\.env',
     "kenxcode_env_access", "critical", "exfiltration",
     "directly references KenXCode secrets file"),
    ...
    (r'\.kenxcode/config\.yaml|\.kenxcode/SOUL\.md',
     "kenxcode_config_mod", "critical", "persistence",
     "references KenXCode configuration files directly"),
...
# scan. `.skillignore` is the KenXCode-native name; `.clawhubignore` is honored
