"""Client for uploading ``kenxcode debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``kenxcode debug share``.
...
NAS_BASE = os.environ.get(
    "KENXCODE_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "kenxcode-agent/debug-share"
