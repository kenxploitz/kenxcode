...
Entry point: ``kenxcode whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``kenxcode_cli/main.py``).
...
KenXCode gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures KenXCode to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  KenXCode needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the KenXCode gateway in another terminal:")
    print("         kenxcode gateway")
    print()
    ...
    print()
    print("  Docs: https://kenxcode-agent.nousresearch.com/docs/user-guide/")
