"""``kenxcode tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'kenxcode tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # kenxcode tools list [--platform cli]
    ...
    # kenxcode tools disable <name...> [--platform cli]
    ...
    # kenxcode tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `kenxcode tools` runs after you pick a provider that\n"
