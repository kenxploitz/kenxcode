...
Data file: $KENXCODE_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_KENXCODE_HOME = Path(os.environ.get("KENXCODE_HOME", Path.home() / ".kenxcode"))
DATA_DIR = _KENXCODE_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
