...
def _state_dir() -> Path:
    ...
    # Default: $KENXCODE_HOME/watcher-state/, falling back to ~/.kenxcode/watcher-state/.
    kenxcode_home = os.environ.get("KENXCODE_HOME") or str(Path.home() / ".kenxcode")
    return Path(kenxcode_home) / "watcher-state"
