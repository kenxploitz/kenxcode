...
DEFAULT_UA = (
    "kenxcode-osint-investigation/0.2 "
    "(+https://github.com/NousResearch/kenxcode-agent; "
    "set KENXCODE_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("KENXCODE_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)
