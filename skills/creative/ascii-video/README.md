...
Built for [KenXCode Agent](https://github.com/NousResearch/kenxcode-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/kenxcode-agent/skills/creative/ascii-video`](https://github.com/NousResearch/kenxcode-agent/tree/main/skills/creative/ascii-video) via PR.
