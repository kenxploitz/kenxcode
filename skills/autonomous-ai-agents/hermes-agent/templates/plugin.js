/**
 * KenXCode desktop plugin template. Save as:
 *   <kenxcode home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <kenxcode home> is ~/.kenxcode by default, or ~/.kenxcode/profiles/<name>
 * when running a named profile (`kenxcode -p <name>`). Run `kenxcode doctor` (or
 ...
 * Only these imports resolve: @kenxcode/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@kenxcode/plugin-sdk'
