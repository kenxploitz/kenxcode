...
Registry of record: `kenxcode_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore KenXCode config+state snapshots (CLI)
...
/update                  Update KenXCode to latest
