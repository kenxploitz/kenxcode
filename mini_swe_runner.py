#!/usr/bin/env python3
"""
SWE Runner with KenXCode Trajectory Format

A runner that uses KenXCode-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the KenXCode-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses KenXCode-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in KenXCode format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches KenXCode-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using KenXCode-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with KenXCode Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses KenXCode-Agent's built-in execution environments
    and outputs trajectories in KenXCode-Agent format.
    """
    ...
    def _convert_to_kenxcode_format(
        self,
        ...
        """
        Convert internal message format to KenXCode trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to KenXCode trajectory format
        trajectory = self._convert_to_kenxcode_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with KenXCode trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with KenXCode Trajectory Format")
    print("=" * 60)
