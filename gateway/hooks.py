...
Hooks are discovered from ~/.kenxcode/hooks/ directories, each containing:
...
Context dict passed to ``agent:start`` / ``agent:end`` handlers:
  ...
  session_id   -- KenXCode session id
...
HOOKS_DIR = get_kenxcode_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"kenxcode_hook_{hook_name}"
