...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$KENXCODE_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_kenxcode_dir("platforms/whatsapp/session", "whatsapp/session")
