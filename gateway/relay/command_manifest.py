...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your KenXCode session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show KenXCode session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running KenXCode agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update KenXCode Agent to the latest version"},
        {"name": "restart", "description": "Gracefully restart the KenXCode gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a KenXCode session in it",
