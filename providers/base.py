...
def _profile_user_agent() -> str:
    """Return a ``kenxcode-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from kenxcode_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"kenxcode-cli/{_ver}"
    except Exception:
        return "kenxcode-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # kenxcode-cli UA so the catalog endpoint is reachable.
