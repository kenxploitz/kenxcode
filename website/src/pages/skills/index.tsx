        ...
        {expanded && (
          <div className={styles.cardDetail}>
            ...
            <div className={styles.installHint}>
              <code>{skill.installCmd || `kenxcode skills install ${skill.name}`}</code>
              <CopyButton
                text={skill.installCmd || `kenxcode skills install ${skill.name}`}
              />
            </div>
...
export default function SkillsDashboard() {
  ...
  return (
    <Layout
      title="Skills Hub"
      description="Browse all skills and plugins available for KenXCode Agent"
    >
      <div className={styles.page}>
        <header className={styles.hero}>
          <div className={styles.heroGlow} />
          <div className={styles.heroContent}>
            <p className={styles.heroEyebrow}>KenXCode Agent</p>
