  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the KenXCode Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use KenXCode &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with KenXCode?{' '}
        <a
          href="https://github.com/NousResearch/kenxcode-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
