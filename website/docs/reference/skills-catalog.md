...
| [`kenxcode-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-kenxcode-agent) | Use, configure, theme, extend, and orchestrate KenXCode Agent. | `autonomous-ai-agents/kenxcode-agent` |
...
| [`kenxcode-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-kenxcode-agent-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development/kenxcode-agent-skill-authoring` |
| [`inspecting-kenxcode-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-kenxcode-desktop-dom) | Read the live KenXCode desktop DOM/CSS over CDP. | `software-development/inspecting-kenxcode-desktop-dom` |
...
| [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) | Write a markdown plan to .kenxcode/plans/; no execution. | `software-development/plan` |
