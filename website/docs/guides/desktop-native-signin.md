...
description: "How the KenXCode Desktop app signs in to a gated gateway using your system browser and PKCE — no embedded webview, no session cookies"
---

# Desktop Native Sign-In (RFC 8252)

When the KenXCode Desktop app connects to a **gated gateway** (a hosted or
...
For KenXCode specifically, native sign-in means:
...
- [Run KenXCode with Nous Portal](./run-kenxcode-with-nous-portal.md)
