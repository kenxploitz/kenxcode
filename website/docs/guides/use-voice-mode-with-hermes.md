---
sidebar_position: 8
title: "Use Voice Mode with KenXCode"
description: "A practical guide to setting up and using KenXCode voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with KenXCode
...
- you want KenXCode sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in KenXCode.
...
## Step 1: make sure normal KenXCode works first
...
KenXCode supports both local and cloud speech stacks.
...
4. KenXCode transcribes and responds
...
- asking KenXCode to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full KenXCode loop.

## Tuning CLI behavior

### Silence threshold

If KenXCode starts/stops too aggressively, tune:
...
KenXCode stays a normal chat bot, but can speak replies.
...
- you want KenXCode to function like a portable research or ops assistant
...
KenXCode joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- KenXCode detects speech boundaries
- transcripts are posted in the associated text channel
- KenXCode responds in text and audio
...
1. get text KenXCode working
2. run `kenxcode setup tts` to enable voice support
