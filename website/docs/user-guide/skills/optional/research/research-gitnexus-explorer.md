...
| | |
|---|---|
| Source | Optional — install with `kenxcode skills install official/research/gitnexus-explorer` |
...
| Related skills | [`kenxcode-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-kenxcode-agent), [`codebase-inspection`](/docs/user-guide/skills/bundled/github/github-codebase-inspection) |
...
- **The web UI does NOT create `.claude/` or `CLAUDE.md`.** Those are created by
  ...
  kenxcode-agent users don't need.
