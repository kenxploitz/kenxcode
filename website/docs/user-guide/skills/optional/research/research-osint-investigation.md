...
| | |
|---|---|
| Source | Optional — install with `kenxcode skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | KenXCode Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $KENXCODE_OSINT_CACHE/icij/ (default: ~/.cache/kenxcode-osint/icij/).
...
# Set KENXCODE_OSINT_UA=your-app/1.0 (your@email) to identify yourself
