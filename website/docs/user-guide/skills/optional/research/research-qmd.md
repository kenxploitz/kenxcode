...
| | |
|---|---|
| Source | Optional — install with `kenxcode skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`kenxcode-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-kenxcode-agent), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
...
KenXCode Agent via the native MCP client. This is the preferred
...
Then configure KenXCode Agent to connect via HTTP:
