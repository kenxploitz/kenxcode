...
| | |
|---|---|
| Source | Optional — install with `kenxcode skills install official/web-development/page-agent` |
...
- User wants **KenXCode itself to drive a browser** → use KenXCode' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
