...
| | |
|---|---|
| Source | Optional — install with `kenxcode skills install official/health/neuroskill-bci` |
...
Connect KenXCode to a running [NeuroSkill](https://neuroskill.com/) instance to read
