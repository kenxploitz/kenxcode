...
| | |
|---|---|
| Source | Optional — install with `kenxcode skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing kenxcode tool access (web_search, file ops). Stateless. |
