...
| | |
|---|---|
| Source | Optional — install with `kenxcode skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), KenXCode Agent |
| License | MIT |
...
The script reads `${KENXCODE_HOME:-~/.kenxcode}/.env` for two optional defaults:
...
Helper script: `~/.kenxcode/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.kenxcode/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${KENXCODE_HOME:-~/.kenxcode}/.env`.
...
```bash
python3 ~/.kenxcode/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.kenxcode/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
