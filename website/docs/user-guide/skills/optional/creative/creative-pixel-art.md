...
| | |
|---|---|
| Source | Optional — install with `kenxcode skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.kenxcode/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.kenxcode/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — KenXCode installs package this)
