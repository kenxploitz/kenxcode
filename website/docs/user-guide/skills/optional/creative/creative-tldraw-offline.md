...
| | |
|---|---|
| Source | Optional — install with `kenxcode skills install official/creative/tldraw-offline` |
| Path | `optional-skills/creative/tldraw-offline` |
| Version | `1.0.0` |
| Author | Teknium + KenXCode Agent |
| License | MIT |
...
- **Agent skills installed in the app**: `Develop → Install Agent Skills`. The
  ...
  recipes below. (This KenXCode skill mirrors that guidance for KenXCode.)
