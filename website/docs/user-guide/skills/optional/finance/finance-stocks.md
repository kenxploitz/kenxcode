...
| | |
|---|---|
| Source | Optional — install with `kenxcode skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), KenXCode Agent |
| License | MIT |
...
```
SCRIPT=~/.kenxcode/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.kenxcode/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
