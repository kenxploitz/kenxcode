...
```bash
python3 -m pyfiglet "KENXCODE" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=KENXCODE&font=Slant" | boxes -d stone
```
