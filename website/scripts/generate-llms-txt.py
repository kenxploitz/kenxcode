#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the KenXCode docs site.
...
Both publish at:
  https://kenxcode-agent.nousresearch.com/docs/llms.txt
  https://kenxcode-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://kenxcode-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use KenXCode as a Python Library", None),
        ("guides/use-mcp-with-kenxcode", "Use MCP with KenXCode", None),
        ("guides/use-voice-mode-with-kenxcode", "Use Voice Mode with KenXCode", None),
        ("guides/use-soul-with-kenxcode", "Use SOUL.md with KenXCode", None),
        ("guides/build-a-kenxcode-plugin", "Build a KenXCode Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with KenXCode"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "kenxcode-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/kenxcode-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# KenXCode Agent — Full Documentation\n",
        (
            "This file is the entire KenXCode Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using KenXCode, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://kenxcode-agent.nousresearch.com/docs\n",
        "Short index: https://kenxcode-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
