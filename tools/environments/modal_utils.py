"""Shared KenXCode-side execution flow for Modal transports.

This module deliberately stops at the KenXCode boundary:
- command preparation
...
def wrap_modal_stdin_heredoc(command: str, stdin_data: str) -> str:
    ...
    marker = f"KENXCODE_EOF_{uuid.uuid4().hex[:8]}"
