...
def live_transcript_root() -> Path:
    """Root directory for live transcripts (profile-safe, never ~/.kenxcode)."""
    from kenxcode_constants import get_kenxcode_dir

    return get_kenxcode_dir("cache/delegation", "delegation_cache") / "live"
...
class LiveTranscriptWriter:
    ...
    def __init__(self, delegation_id: str, task_index: int, goal: str,
        ...
        try:
            ...
            header = [
                "=== KenXCode subagent live transcript ===",
