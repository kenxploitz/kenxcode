...
`hey_kenxcode.onnx` / `hey_kenxcode.tflite` — the on-device "Hey KenXCode" hotword
...
- **Label:** the model registers as `hey_kenxcode` (matches the filename).
