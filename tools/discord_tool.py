...
Only included in the kenxcode-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "KenXCode-Agent (https://github.com/NousResearch/kenxcode-agent)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_kenxcode_home() / "cache" / "discord_capabilities.json"
