...
# When the user hasn't picked a reasoning effort, KenXCode passes
...
# ON at this effort — matching the "medium (default)" that KenXCode' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map KenXCode' effort vocabulary onto Solar's accepted set. xhigh/max/
