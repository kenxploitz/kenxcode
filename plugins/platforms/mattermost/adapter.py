...
required — uses aiohttp which is already a KenXCode dependency.
...
def interactive_setup() -> None:
    ...
    ``kenxcode_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where KenXCode delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # kenxcode_cli/setup.py::_setup_mattermost function.
