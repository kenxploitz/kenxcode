...
Config: ~/.kenxcode/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.kenxcode/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_kenxcode_home()`` helper (KENXCODE_HOME-aware and
...
RULES_FILE = get_kenxcode_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_kenxcode_home() / "feishu_comment_pairing.json"
