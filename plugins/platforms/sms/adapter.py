...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> KenXCode gateway adapter.

    Each inbound phone number gets its own KenXCode session (multi-tenant).
...
# static dict in kenxcode_cli/gateway.py, and the _send_sms dispatch in
