# KenXCode Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.kenxcode/plugins/kenxcode-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.kenxcode/plugins/kenxcode-achievements/scan_checkpoint.json`.
