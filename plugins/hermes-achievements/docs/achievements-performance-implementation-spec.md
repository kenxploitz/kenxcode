# KenXCode Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.kenxcode/plugins/kenxcode-achievements/state.json` (existing unlock state)
  - `~/.kenxcode/plugins/kenxcode-achievements/scan_snapshot.json` (new)
  - `~/.kenxcode/plugins/kenxcode-achievements/scan_checkpoint.json` (new)
