...
// by main.ts (`setBackgroundThrottling` driven by the merged `kenxcode:active-work`
...
// (the "KenXCode idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey KenXCode" wake word has NO preceding click,
