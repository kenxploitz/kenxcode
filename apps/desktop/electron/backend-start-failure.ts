 ...
 * startKenXCode() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startKenXCode() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startKenXCode`, re-emits
