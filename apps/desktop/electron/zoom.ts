...
export const ZOOM_STORAGE_KEY = 'kenxcode:desktop:zoomLevel'
 ...
 * but forgot to emit 'kenxcode:zoom:changed', leaving the control stuck at 100%.
...
export function applyZoomLevel(webContents, level) {
  ...
  webContents.send('kenxcode:zoom:changed', { level: clamped, percent: zoomLevelToPercent(clamped) })
