...
// even though a fresh shell — and the KenXCode CLI — sees it immediately. The
// desktop's KENXCODE_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\kenxcode. Reading
...
//       KENXCODE_HOME    REG_SZ    F:\KenXCode\data
//
