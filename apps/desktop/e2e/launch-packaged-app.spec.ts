...
/**
 * E2E smoke tests for the packaged KenXCode desktop app.
 *
 ...
 * (credential stripping, isolated KENXCODE_HOME + userData, unique app name).
 *
...
test('window opens with the KenXCode title', async () => {
