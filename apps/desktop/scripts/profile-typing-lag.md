...
cd apps/desktop
XCURSOR_SIZE=24 KENXCODE_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/kenxcode-typing
# → /tmp/kenxcode-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/kenxcode-typing.before.heapsnapshot
# → /tmp/kenxcode-typing.after.heapsnapshot
```
