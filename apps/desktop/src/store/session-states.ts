...
const TILES_KEY = 'kenxcode.desktop.sessionTiles.v2'
const LEGACY_TILES_KEY = 'kenxcode.desktop.sessionTiles.v1'
...
// Dev hook for automation (mirrors __KENXCODE_LAYOUT_TREE__).
if (import.meta.env.DEV && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__KENXCODE_SESSION_TILES__ = {
