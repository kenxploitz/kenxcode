...
const POPOUT_STORAGE_KEY = 'kenxcode.desktop.composerPopout.zones.v1'
...
const LEGACY_ENABLED_KEY = 'kenxcode.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'kenxcode.desktop.composerPopout.position'
