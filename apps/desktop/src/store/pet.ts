...
export interface PetInfo {
  ...
  // the KenXCode "run" activity state uses the in-place running row).
 ...
 * KENXCODE_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'kenxcode.desktop.pet-roam.v1'
