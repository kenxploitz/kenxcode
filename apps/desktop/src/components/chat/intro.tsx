...
const FALLBACK_COPY: IntroCopy[] = [
  ...
  {
    headline: 'What should KenXCode look at?',
...
function fallbackCopyForPersonality(personalityKey: string): IntroCopy[] {
  ...
  return [
    ...
    {
      headline: `What does ${label} KenXCode need to see?`,
    ...
    {
      headline: `What should ${label} KenXCode tackle?`,
