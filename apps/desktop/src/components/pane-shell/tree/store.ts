...
const STORAGE_KEY = 'kenxcode.desktop.layoutTree.v2'

writeKey('kenxcode.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('kenxcode.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('kenxcode.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'kenxcode.desktop.dismissedPanes.v1'
...
const USER_PLACED_KEY = 'kenxcode.desktop.userPlacedPanes.v1'
...
if (import.meta.env.DEV && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__KENXCODE_LAYOUT_TREE__ = {
    close: closeTreePane,
