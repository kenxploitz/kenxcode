...
export interface Translations {
  ...
  boot: {
    ...
    steps: {
      ...
      startingKenXCodeDesktop: string
    }
    errors: {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshKeyTitle: string
      sshKeyDesc: string
      sshKenXCodePathTitle: string
      sshKenXCodePathDesc: string
      sshKenXCodePathPlaceholder: string
  ...
  commandCenter: {
    ...
    kenxcodeActiveSessions: (version: string, count: number) => string
