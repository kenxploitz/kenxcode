...
export const en: Translations = {
  ...
  boot: {
    ready: 'KenXCode Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading KenXCode settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingKenXCodeDesktop: 'Starting KenXCode Desktop…'
    },
    errors: {
      backgroundExited: 'KenXCode background process exited.',
      backgroundExitedDuringStartup: 'KenXCode background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your KenXCode backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateKenXCode: 'Update KenXCode',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting KenXCode Desktop.',
    ...
    native: {
      ...
      inputBody: 'KenXCode is waiting for your response.',
      turnDoneTitle: 'KenXCode finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to KenXCode defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while KenXCode is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'KenXCode asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while KenXCode was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let KenXCode follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and KenXCode can react to yours.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what KenXCode is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen KenXCode, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'KenXCode checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading KenXCode configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening KenXCode.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a KenXCode backend elsewhere. Per-profile overrides below.',
      ...
      envOverrideDesc:
        'Unset KENXCODE_DESKTOP_REMOTE_URL and KENXCODE_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private KenXCode backend on localhost. This is the default and works offline.',
      inheritTitle: 'Use default gateway',
      inheritDesc: "Remove this profile's override and use the default connection.",
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote KenXCode backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'KenXCode Cloud',
      cloudDesc: 'Sign in once to KenXCode Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'KenXCode Cloud',
      cloudSignIn: 'Sign in to KenXCode Cloud',
      cloudSignedIn: 'Signed in to KenXCode Cloud',
      cloudNeedsSignIn: 'Sign in to KenXCode Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your KenXCode Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'KenXCode Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of KenXCode Cloud',
      cloudSignedOutMessage: 'Cleared the KenXCode Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /kenxcode.',
      ...
      restartingMessage: 'KenXCode Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · KenXCode ${version}` : ''}`,
      ...
      sshDesc:
        'KenXCode is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshKenXCodePathTitle: 'KenXCode path (optional)',
      sshKenXCodePathDesc: 'Full path to the remote kenxcode binary. Blank = auto-detect.',
      sshKenXCodePathPlaceholder: 'auto-detect',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — KenXCode found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — KenXCode runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'KenXCode is not installed on the remote host. Install it there (curl -fsSL https://kenxcode-agent.nousresearch.com/install.sh | sh) or set the KenXCode path.',
      sshErrPlatform:
        'Unsupported remote platform. KenXCode Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update KenXCode on the remote host before connecting with Desktop SSH.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. KenXCode runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point KenXCode at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via kenxcode curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As KenXCode builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart KenXCode to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update KenXCode to generate pets.',
      backgroundHint: 'You can close this — KenXCode will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure KenXCode desktop' },
    ...
    kenxcodeActiveSessions: (version, count) => `KenXCode ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@kenxcode:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent KenXCode environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. KenXCode will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the KenXCode backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from KenXCode. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting KenXCode...',
    placeholderReconnecting: 'Reconnecting to KenXCode…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give KenXCode a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'KenXCode will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask KenXCode to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating KenXCode…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting KenXCode…',
    ...
    unsupportedMessage: 'This version of KenXCode can’t update itself from inside the app.',
    ...
    manualBody: 'You installed KenXCode from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'KenXCode will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the KenXCode desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The KenXCode updater takes over in its own window and reopens KenXCode automatically when it’s done. Please don’t reopen KenXCode yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. KenXCode reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then KenXCode reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'KenXCode needs a one-time install',
    ...
    setupChoiceTitle: 'Set up KenXCode Desktop',
    setupChoiceDesc:
      'Connect this app to a KenXCode gateway you already run, or install KenXCode locally on this computer.',
    connectExistingTitle: 'Connect to existing KenXCode',
    ...
    installLocalTitle: 'Install KenXCode locally',
    installLocalDesc: 'Download KenXCode, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart KenXCode Desktop and try again.',
    remoteSetupTitle: 'Connect to existing KenXCode',
    remoteSetupDesc: 'Enter your gateway URL. KenXCode Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the KenXCode gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/kenxcode',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that KenXCode gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up KenXCode Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another KenXCode CLI or desktop instance is running. Stop any running KenXCode instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with KenXCode Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'KenXCode is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting KenXCode…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run KenXCode',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point KenXCode at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — KenXCode connects automatically',
    ...
    authorizeThere: 'Authorize KenXCode there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize KenXCode there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `KenXCode Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `KenXCode Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. KenXCode will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'KenXCode is restarting...',
      askRestart: 'Ask KenXCode to restart the server',
      lookingRestart: taskId => `KenXCode is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'KenXCode is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `KenXCode finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'KenXCode could not restart the server.',
      stillWorking:
        'KenXCode is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'KenXCode is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'KenXCode gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.kenxcode/config.yaml). KenXCode won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'KenXCode needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'KenXCode needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart KenXCode Desktop to use Save Image.',
    restartToSaveImages: 'Restart KenXCode Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `kenxcode gateway` running?'
    }
  },
