 ...
 * `<kenxcode home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'kenxcode.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'kenxcode.desktop.disabledPlugins.v1'
