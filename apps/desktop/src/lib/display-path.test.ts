...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/kenxcode-agent')).toBe('~/www/kenxcode-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/kenxcode-agent')).toBe('kenxcode-agent')
    expect(pathLeaf('~/www/kenxcode-agent')).toBe('kenxcode-agent')
