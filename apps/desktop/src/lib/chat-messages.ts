...
import { type BillingBlock, skillInvocationText } from '@kenxcode/shared'
...
import type { MessageReaction, SessionMessage, UsageStats } from '@/types/kenxcode'
...
export type GatewayEventPayload = {
  ...
  // with FailoverReason.billing (shape mirrors @kenxcode/shared BillingBlock).
