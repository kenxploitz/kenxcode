/**
 * @kenxcode/plugin-sdk — THE plugin language. The vscode-module model: plugin
 ...
 *    object as `window.__KENXCODE_PLUGIN_SDK__` and maps the import to it, so a
...
import { getLogs, getStatus } from '@/kenxcode'
...
/** KenXCode' reasoning levels + their compact labels, so a plugin surfacing a
...
export type { RpcEvent, StatusResponse } from '@/types/kenxcode'
