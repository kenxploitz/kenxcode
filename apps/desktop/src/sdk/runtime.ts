 ...
 * plugins resolve `@kenxcode/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __KENXCODE_PLUGIN_SDK__: sdk,
  __KENXCODE_REACT__: React,
  __KENXCODE_REACT_JSX__: jsxRuntime,
  __KENXCODE_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@kenxcode/plugin-sdk': shimUrl('__KENXCODE_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__KENXCODE_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__KENXCODE_REACT_JSX__'),
    react: shimUrl('__KENXCODE_REACT__')
  }
