/**
 * KenXCode skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$KENXCODE_HOME/skins/` (or a
 * built-in) resolved by `kenxcode_cli/skin_engine.py` and pushed to every surface
 ...
 * skin KenXCode authors from a prompt lights up all three surfaces from one file.
 *
...
import type { KenXCodeSkin, SkinColors } from '@kenxcode/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: KenXCodeSkin): DesktopTheme | null {
