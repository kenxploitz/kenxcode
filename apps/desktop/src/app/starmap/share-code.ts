...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/kenxcode'
...
const VERSION = 3
const PREFIX = 'HML' // "KenXCode Memory Loadout" — namespaces our codes like WoW's leading bytes.
