...
import type { ConfigFieldSchema, KenXCodeConfigRecord, ToolsetInfo } from '@/types/kenxcode'
...
export function getNested(obj: KenXCodeConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: KenXCodeConfigRecord, path: string, value: unknown): KenXCodeConfigRecord {
...
function personalityOptions(config: KenXCodeConfigRecord): string[] {
...
function commandProviderNames(config: KenXCodeConfigRecord, section: 'tts' | 'stt'): string[] {
