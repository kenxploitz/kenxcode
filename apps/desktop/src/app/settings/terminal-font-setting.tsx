...
import { saveKenXCodeConfig } from '@/kenxcode'
...
function fontFamilyFromConfig(config: KenXCodeConfigRecord): string {
...
export function TerminalFontSetting() {
  ...
  const { data: loadedConfig } = useKenXCodeConfigRecord()
  ...
  const [staleConfig, setStaleConfig] = useState<KenXCodeConfigRecord | null>(null)
  ...
  useEffect(() => {
    ...
    // holds — successful saves write it back via setKenXCodeConfigCache, so
        ...
        <div className="mt-3 space-y-2">
          <div className="flex items-center gap-3">
            <Input
              ...
              className="flex-1"
              disabled={draft === null}
              list="kenxcode-terminal-font-families"
          ...
          <datalist id="kenxcode-terminal-font-families">
