...
vi.mock('@/kenxcode', () => ({
  saveKenXCodeConfig: (config: Record<string, unknown>) => mocks.save(config)
}))
...
vi.mock('../hooks/use-config-record', () => ({
  setKenXCodeConfigCache: (config: Record<string, unknown>) => mocks.cache(config),
  useKenXCodeConfigRecord: () => ({ data: mocks.loadedConfig })
}))
