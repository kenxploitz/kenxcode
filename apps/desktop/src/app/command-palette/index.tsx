...
import { getKenXCodeConfigRecord, listAllProfileSessions } from '@/kenxcode'
...
// KenXCode session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
...
function CommandPaletteBody({ onExited }: { onExited: () => void }) {
  ...
  const configQuery = useQuery({
    ...
    queryFn: getKenXCodeConfigRecord
  })
        ...
        : []),
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Download,
            id: 'cc-update-kenxcode',
            keywords: ['update', 'upgrade', 'kenxcode', 'version', 'system', 'restart'],
            label: cc.updateKenXCode,
