...
import type { ProjectInfo, SessionInfo } from '@/kenxcode'
 ...
 * repo shows its branches/worktrees even when they have no KenXCode sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: KenXCodeGitWorktree[]
): SidebarSessionGroup[] {
