...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/kenxcode'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('kenxcode:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('kenxcode:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask KenXCode to
