...
const FOCUS_EVENT = 'kenxcode:composer-focus'
const INSERT_EVENT = 'kenxcode:composer-insert'
const INSERT_REFS_EVENT = 'kenxcode:composer-insert-refs'
const SUBMIT_EVENT = 'kenxcode:composer-submit'
const VOICE_TOGGLE_EVENT = 'kenxcode:composer-voice-toggle'
const MODEL_MENU_EVENT = 'kenxcode:composer-model-menu'
