...
import { type DroppedFile, extractDroppedFiles, KENXCODE_PATHS_MIME } from './use-composer-actions'
...
const dragKindOf = (event: ReactDragEvent): DragKind =>
  dragHasAttachments(event.dataTransfer, KENXCODE_PATHS_MIME) ? 'files' : null
