import type { KenXCodeReviewFile } from '@/global'
...
export function buildReviewFlatList(files: KenXCodeReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: KenXCodeReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
