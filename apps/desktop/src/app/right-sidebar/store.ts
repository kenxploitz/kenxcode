...
const TAKEOVER_KEY = 'kenxcode.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which KenXCode can't clear via the API — the user
 *  sees exactly what runs instead of KenXCode silently deleting their creds. */
