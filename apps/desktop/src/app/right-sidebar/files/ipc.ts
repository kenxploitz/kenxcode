...
import type { KenXCodeReadDirEntry, KenXCodeReadDirResult } from '@/global'
...
export type ProjectTreeEntry = KenXCodeReadDirEntry
...
function ignoredBy(rules: GitignoreRule[], entry: KenXCodeReadDirEntry) {
...
async function filterIgnored(entries: KenXCodeReadDirEntry[], rootPath: string, dirPath: string) {
...
export async function readProjectDir(dirPath: string, rootPath = dirPath): Promise<KenXCodeReadDirResult> {
