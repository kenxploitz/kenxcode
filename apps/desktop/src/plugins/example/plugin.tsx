 ...
 * `src/plugins/` with a `plugin.tsx` that default-exports a `KenXCodePlugin` is
 ...
 *
 * The ONLY import surface is `@kenxcode/plugin-sdk` (lint-enforced) — the
