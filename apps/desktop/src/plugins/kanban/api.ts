...
import { atom, type PluginRestOptions, type PluginStorage, queryClient } from '@kenxcode/plugin-sdk'
...
/** First-class KenXCode projects, for scoping a board's default workspace. */
