/**
 * Canonical KenXCode skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$KENXCODE_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`kenxcode_cli/skin_engine.py`),
 ...
 *   • CLI     → `kenxcode_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
