#!/usr/bin/env python3
"""Build the KenXCode Skills Index — a centralized JSON catalog of all skills.
...
`kenxcode skills search/install` can use it without hitting the GitHub API.
...
# Ensure KENXCODE_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building KenXCode Skills Index...", flush=True)
