...
def main() -> None:
    ...
    kenxcode_home = Path(tempfile.mkdtemp(prefix="kenxcode-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "kenxcode-gateway-smoke",
    ...
    print(json.dumps({"kenxcode_home": str(kenxcode_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
