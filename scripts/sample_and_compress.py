...
DEFAULT_DATASETS = [
    ...
    "NousResearch/kenxcode-agent-megascience-sft1",
    "NousResearch/KenXCode-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/KenXCode-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-kenxcode-agent"
]
