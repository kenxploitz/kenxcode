...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^KenXCode\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "kenxcode@nousresearch.com",
    "kenxcode-audit@example.com",
    "nousbot@nousresearch.com",
    "kenxcode@habibilabs.dev",
    "omx@oh-my-codex.dev",
    "codex@openai.com",
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "NousResearch/kenxcode-agent",
                "--state", "merged",
