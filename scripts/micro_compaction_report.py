#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from KenXCode logs.
...
With no LOGFILE, reads ``$KENXCODE_HOME/logs/agent.log`` (default ~/.kenxcode).
...
def default_log() -> Path:
    home = os.environ.get("KENXCODE_HOME") or str(Path.home() / ".kenxcode")
