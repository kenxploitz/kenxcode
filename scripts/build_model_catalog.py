#!/usr/bin/env python3
"""Build the KenXCode Model Catalog — a centralized JSON manifest of curated models.
...
KenXCode CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a KenXCode release.
...
# Ensure KENXCODE_HOME is set for imports that touch it at module level.
os.environ.setdefault("KENXCODE_HOME", os.path.join(os.path.expanduser("~"), ".kenxcode"))

from kenxcode_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "kenxcode-agent repo",
            "docs": "https://kenxcode-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model KenXCode '
