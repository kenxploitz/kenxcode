 ...
 * across theme x background scenes to <tmpdir>/kenxcode-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@kenxcode/ink'
...
// The regenerated slate light_colors block from kenxcode_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/kenxcode-agent',
...
const setup = (bgHex: string) => {
  process.env.KENXCODE_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
