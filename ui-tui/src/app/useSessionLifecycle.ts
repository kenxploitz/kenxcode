...
import type { ScrollBoxHandle } from '@kenxcode/ink'
import { evictInkCaches } from '@kenxcode/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.KENXCODE_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
