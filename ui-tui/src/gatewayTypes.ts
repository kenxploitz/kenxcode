import type { BillingBlock, UsageModelData } from '@kenxcode/shared/billing'
import type { KenXCodeSkin } from '@kenxcode/shared/skin'

import type { SessionInfo, SlashCategory, SubagentStatus, Usage } from './types.js'

/** The cross-surface skin contract (canonical shape in `@kenxcode/shared`).
 *  Includes the paired light_colors/dark_colors overlays from #20379. */
export type GatewaySkin = KenXCodeSkin
...
// Wire shapes now live in @kenxcode/shared for reuse by TypeScript clients.
export type {
  BillingAutoReload,
  BillingBlock,
  BillingCardInfo,
