 ...
 *
 * Symptom: in `kenxcode --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@kenxcode/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using kenxcode --tui and as i type multiline my caret at the end will often ' +
