import { Box, type ScrollBoxHandle, stringWidth, Text } from '@kenxcode/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (KENXCODE_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (KENXCODE_DEV_CREDITS), lowest priority,
